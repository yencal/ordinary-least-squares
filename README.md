...
* Method 2: computes the OLS by first rearanging the Normal Equation as $(X^{T}X) \beta = X^{T}y$. and then solve the system of linear equations <img src="https://render.githubusercontent.com/render/math?math=Ax = b"> using the LU factorization method. This method is refered to as the AxbLU method hereafter.
